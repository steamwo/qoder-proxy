...
<div class="shell">
  ...
  <section id="models" class="panel">
    <div class="card">
      ...
      <div class="notice" style="margin-bottom:14px">上下文档位来自实时 Qoder context_config，思考等级来自 thinking_config；“自动”表示不覆盖上游默认行为。</div>
